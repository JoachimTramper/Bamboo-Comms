...
export function ChatHeader({
  ...
  function handleChangeUsernameClick() {
    const next = prompt("New username?", user.displayName) ?? "";
  ...
  return (
    <header className="relative z-40 border-b border-stone-200 md:border-b-0 bg-stone-200 md:bg-stone-100 px-3 sm:px-4 py-2 flex items-center md:grid md:grid-cols-[18rem_1fr] md:items-center">
